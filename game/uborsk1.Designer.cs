...
namespace game
{
    partial class uborsk1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Руководство увольняет уборщицу, но вам придется восстанавливать файл \r\nсвоими сил" +
    "ами. Проект удается завершить в срок, но вы теряете доверие руководства.";
